...
LAB_ROUTER_WAN_INTERFACE=""
LAB_ROUTER_LAN_INTERFACE=""
CLIENT_INTERFACE=""
NAT_TABLE=""
NAT_CHAIN=""
FILTER_TABLE=""
...
load_topology_config() {
  ...
  while IFS='=' read -r key value; do
    case "$key" in
      ...
      PHYSICAL_WAN_MODE) PHYSICAL_WAN_MODE="$value" ;;
      ...
      LAN_HEALTH_TARGET) LAN_HEALTH_TARGET="$value" ;;
      INTERNET_HEALTH_TARGET) INTERNET_HEALTH_TARGET="$value" ;;
    esac
  done < "$HVR_CONFIG"
  PHYSICAL_WAN_MODE="${PHYSICAL_WAN_MODE:-static}"
  LAB_ROUTER_WAN_INTERFACE="$ROUTER_WAN_INTERFACE"
  LAB_ROUTER_LAN_INTERFACE="$ROUTER_LAN_INTERFACE"
