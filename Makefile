...
help:
	...
	@echo "  physical-hardware-test-observe-nat      capture NAT while operator generates client traffic"
	@echo "  physical-hardware-test-observe-firewall capture controlled WAN probe and prove LAN block"
	@echo "  physical-hardware-test-verify           require router-local client/IPFIX/metrics evidence"
	@echo "  physical-hardware-test-stop             stop or resume stop; verify restoration/residue"
...
install-management-api-support:
	sudo router/scripts/management-support-control.sh install

verify-management-api-support:
	sudo router/scripts/management-support-control.sh verify

uninstall-management-api-support:
	sudo router/scripts/management-support-control.sh uninstall
...
systemd-install:
	sudo router/scripts/systemd-control.sh install

systemd-uninstall:
	sudo router/scripts/systemd-control.sh uninstall

systemd-enable:
	sudo router/scripts/systemd-control.sh enable

systemd-disable:
	sudo router/scripts/systemd-control.sh disable

systemd-start:
	sudo router/scripts/systemd-control.sh start

systemd-stop:
	sudo router/scripts/systemd-control.sh stop

systemd-status:
	sudo router/scripts/systemd-control.sh status
